...
//Bob Add
  for (var i=1; i < 7; i++){
    var promotionListHover = function(num){
        return function(){
          $(".promotion-list-header-"+num).hover(function(){
            //console.log("promotion-list-header-"+num+"is hovered!!");
            if($(".promotion-list-"+num).is(':hidden')){
              $(".promotion-list:not('.promotion-list-"+i+"'):visible").hide();
              $(".promotion-list-"+num).show();
            }
          });
        };
    };
    promotionListHover(i)();
  }
